...
// (DO NOT EDIT: machine generated header) 'dclfrxADO16.pas' rev: 23.00 (Win32)

#ifndef Dclfrxado16HPP
#define Dclfrxado16HPP
...
namespace Dclfrxado16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfrxado16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXADO16)
using namespace Dclfrxado16;
#endif
#pragma pack(pop)
#pragma option pop
