...
// (DO NOT EDIT: machine generated header) 'dclfrxBDE16.pas' rev: 23.00 (Win32)

#ifndef Dclfrxbde16HPP
#define Dclfrxbde16HPP
...
namespace Dclfrxbde16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfrxbde16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXBDE16)
using namespace Dclfrxbde16;
#endif
#pragma pack(pop)
#pragma option pop
