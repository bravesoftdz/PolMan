...
// (DO NOT EDIT: machine generated header) 'dclfrxDB16.pas' rev: 23.00 (Win32)

#ifndef Dclfrxdb16HPP
#define Dclfrxdb16HPP
...
namespace Dclfrxdb16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfrxdb16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXDB16)
using namespace Dclfrxdb16;
#endif
#pragma pack(pop)
#pragma option pop
