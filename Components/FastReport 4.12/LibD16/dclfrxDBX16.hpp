...
// (DO NOT EDIT: machine generated header) 'dclfrxDBX16.pas' rev: 23.00 (Win32)

#ifndef Dclfrxdbx16HPP
#define Dclfrxdbx16HPP
...
namespace Dclfrxdbx16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfrxdbx16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXDBX16)
using namespace Dclfrxdbx16;
#endif
#pragma pack(pop)
#pragma option pop
