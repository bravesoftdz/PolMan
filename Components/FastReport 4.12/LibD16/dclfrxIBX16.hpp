...
// (DO NOT EDIT: machine generated header) 'dclfrxIBX16.pas' rev: 23.00 (Win32)

#ifndef Dclfrxibx16HPP
#define Dclfrxibx16HPP
...
namespace Dclfrxibx16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfrxibx16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXIBX16)
using namespace Dclfrxibx16;
#endif
#pragma pack(pop)
#pragma option pop
