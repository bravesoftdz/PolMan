...
// (DO NOT EDIT: machine generated header) 'dclfrxTee16.pas' rev: 23.00 (Win32)

#ifndef Dclfrxtee16HPP
#define Dclfrxtee16HPP
...
namespace Dclfrxtee16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfrxtee16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFRXTEE16)
using namespace Dclfrxtee16;
#endif
#pragma pack(pop)
#pragma option pop
