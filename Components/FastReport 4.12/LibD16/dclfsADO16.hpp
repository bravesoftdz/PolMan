...
// (DO NOT EDIT: machine generated header) 'dclfsADO16.pas' rev: 23.00 (Win32)

#ifndef Dclfsado16HPP
#define Dclfsado16HPP
...
namespace Dclfsado16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfsado16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSADO16)
using namespace Dclfsado16;
#endif
#pragma pack(pop)
#pragma option pop
