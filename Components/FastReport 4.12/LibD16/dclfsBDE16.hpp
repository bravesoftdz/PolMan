...
// (DO NOT EDIT: machine generated header) 'dclfsBDE16.pas' rev: 23.00 (Win32)

#ifndef Dclfsbde16HPP
#define Dclfsbde16HPP
...
namespace Dclfsbde16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfsbde16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSBDE16)
using namespace Dclfsbde16;
#endif
#pragma pack(pop)
#pragma option pop
