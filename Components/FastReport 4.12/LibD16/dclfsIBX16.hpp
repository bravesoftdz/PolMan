...
// (DO NOT EDIT: machine generated header) 'dclfsIBX16.pas' rev: 23.00 (Win32)

#ifndef Dclfsibx16HPP
#define Dclfsibx16HPP
...
namespace Dclfsibx16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfsibx16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSIBX16)
using namespace Dclfsibx16;
#endif
#pragma pack(pop)
#pragma option pop
