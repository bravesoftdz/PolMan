...
// (DO NOT EDIT: machine generated header) 'dclfsTee16.pas' rev: 23.00 (Win32)

#ifndef Dclfstee16HPP
#define Dclfstee16HPP
...
namespace Dclfstee16
{
//-- type declarations -------------------------------------------------------
//-- var, const, procedure ---------------------------------------------------

}	/* namespace Dclfstee16 */
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_DCLFSTEE16)
using namespace Dclfstee16;
#endif
#pragma pack(pop)
#pragma option pop
