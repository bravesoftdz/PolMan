...
// (DO NOT EDIT: machine generated header) 'fqb160.pas' rev: 23.00 (Win32)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FQB160)
using namespace Fqb160;
#endif
#pragma pack(pop)
#pragma option pop
