...
// (DO NOT EDIT: machine generated header) 'frxADO16.pas' rev: 23.00 (Win32)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXADO16)
using namespace Frxado16;
#endif
#pragma pack(pop)
#pragma option pop
