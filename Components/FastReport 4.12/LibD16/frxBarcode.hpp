...
// (DO NOT EDIT: machine generated header) 'frxBarcode.pas' rev: 23.00 (Win32)
...
__published:
	...
	__property Font;
public:
	/* TfrxComponent.DesignCreate */ inline __fastcall virtual TfrxBarCodeView(System::Classes::TComponent* AOwner, System::Word Flags) : Frxclass::TfrxView(AOwner, Flags) { }
