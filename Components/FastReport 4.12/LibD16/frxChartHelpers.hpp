...
// (DO NOT EDIT: machine generated header) 'frxChartHelpers.pas' rev: 23.00 (Win32)
...
extern PACKAGE TfrxSeriesHelper* __fastcall frxFindSeriesHelper(Vcltee::Teengine::TChartSeries* Series);
