...
// (DO NOT EDIT: machine generated header) 'frxClass.pas' rev: 23.00 (Win32)
...
public:
	...
	/* Exception.CreateRes */ inline __fastcall EDuplicateName(int Ident)/* overload */ : System::Sysutils::Exception(Ident) { }
	/* Exception.CreateResFmt */ inline __fastcall EDuplicateName(int Ident, System::TVarRec const *Args, const int Args_Size)/* overload */ : System::Sysutils::Exception(Ident, Args, Args_Size) { }
	...
	/* Exception.CreateResHelp */ inline __fastcall EDuplicateName(int Ident, int AHelpContext)/* overload */ : System::Sysutils::Exception(Ident, AHelpContext) { }
...
enum Frxclass__3 : unsigned char { csContainer, csPreviewVisible, csDefaultDiff };
#pragma option pop

typedef System::Set<Frxclass__3, Frxclass__3::csContainer, Frxclass__3::csDefaultDiff>  TfrxComponentStyle;

#pragma option push -b-
enum TfrxStretchMode : unsigned char { smDontStretch, smActualHeight, smMaxHeight };
#pragma option pop

#pragma option push -b-
enum TfrxShiftMode : unsigned char { smDontShift, smAlways, smWhenOverlapped };
#pragma option pop

#pragma option push -b-
enum TfrxDuplexMode : unsigned char { dmNone, dmVertical, dmHorizontal, dmSimplex };
#pragma option pop

#pragma option push -b-
enum TfrxAlign : unsigned char { baNone, baLeft, baRight, baCenter, baWidth, baBottom, baClient };
#pragma option pop

#pragma option push -b-
enum TfrxFrameStyle : unsigned char { fsSolid, fsDash, fsDot, fsDashDot, fsDashDotDot, fsDouble, fsAltDot, fsSquare };
#pragma option pop

#pragma option push -b-
enum TfrxFrameType : unsigned char { ftLeft, ftRight, ftTop, ftBottom };
#pragma option pop

typedef System::Set<TfrxFrameType, TfrxFrameType::ftLeft, TfrxFrameType::ftBottom>  TfrxFrameTypes;

#pragma option push -b-
enum TfrxFormatKind : unsigned char { fkText, fkNumeric, fkDateTime, fkBoolean };
#pragma option pop

#pragma option push -b-
enum TfrxHAlign : unsigned char { haLeft, haRight, haCenter, haBlock };
#pragma option pop

#pragma option push -b-
enum TfrxVAlign : unsigned char { vaTop, vaBottom, vaCenter };
#pragma option pop

#pragma option push -b-
enum TfrxSilentMode : unsigned char { simMessageBoxes, simSilent, simReThrow };
#pragma option pop

#pragma option push -b-
enum TfrxRestriction : unsigned char { rfDontModify, rfDontSize, rfDontMove, rfDontDelete, rfDontEdit };
#pragma option pop

typedef System::Set<TfrxRestriction, TfrxRestriction::rfDontModify, TfrxRestriction::rfDontEdit>  TfrxRestrictions;

#pragma option push -b-
enum TfrxShapeKind : unsigned char { skRectangle, skRoundRectangle, skEllipse, skTriangle, skDiamond, skDiagonal1, skDiagonal2 };
#pragma option pop

#pragma option push -b-
enum TfrxPreviewButton : unsigned char { pbPrint, pbLoad, pbSave, pbExport, pbZoom, pbFind, pbOutline, pbPageSetup, pbTools, pbEdit, pbNavigator, pbExportQuick, pbNoClose, pbNoFullScreen, pbNoEmail };
#pragma option pop

typedef System::Set<TfrxPreviewButton, TfrxPreviewButton::pbPrint, TfrxPreviewButton::pbNoEmail>  TfrxPreviewButtons;

#pragma option push -b-
enum TfrxZoomMode : unsigned char { zmDefault, zmWholePage, zmPageWidth, zmManyPages };
#pragma option pop

#pragma option push -b-
enum TfrxPrintPages : unsigned char { ppAll, ppOdd, ppEven };
#pragma option pop

#pragma option push -b-
enum TfrxAddPageAction : unsigned char { apWriteOver, apAdd };
#pragma option pop

#pragma option push -b-
enum TfrxRangeBegin : unsigned char { rbFirst, rbCurrent };
#pragma option pop

#pragma option push -b-
enum TfrxRangeEnd : unsigned char { reLast, reCurrent, reCount };
#pragma option pop

#pragma option push -b-
enum TfrxFieldType : unsigned char { fftNumeric, fftString, fftBoolean };
#pragma option pop

#pragma option push -b-
enum TfrxProgressType : unsigned char { ptRunning, ptExporting, ptPrinting };
#pragma option pop

#pragma option push -b-
enum TfrxPrintMode : unsigned char { pmDefault, pmSplit, pmJoin, pmScale };
#pragma option pop

#pragma option push -b-
enum TfrxInheriteMode : unsigned char { imDefault, imDelete, imRename };
#pragma option pop
...
private:
	...
	void __fastcall SetFields(const System::Classes::TStrings* Value);
...
private:
	...
	void __fastcall SetFieldAliases(const System::Classes::TStrings* Value);
...
private:
	...
	void __fastcall SetMemo(const System::Widestrings::TWideStrings* Value);
...
private:
	...
	void __fastcall SetPicture(const Vcl::Graphics::TPicture* Value);
...
private:
	...
	void __fastcall SetHGuides(const System::Classes::TStrings* Value);
	void __fastcall SetVGuides(const System::Classes::TStrings* Value);
	void __fastcall SetColumnPositions(const System::Classes::TStrings* Value);
	void __fastcall SetFrame(const TfrxFrame* Value);
	TfrxFrame* __fastcall GetFrame(void);
	System::Uitypes::TColor __fastcall GetColor(void);
	void __fastcall SetColor(const System::Uitypes::TColor Value);
	Vcl::Graphics::TPicture* __fastcall GetBackPicture(void);
	void __fastcall SetBackPicture(const Vcl::Graphics::TPicture* Value);
	void __fastcall SetDataSet(const TfrxDataSet* Value);
	void __fastcall SetDataSetName(const System::UnicodeString Value);
	System::UnicodeString __fastcall GetDataSetName(void);
...
private:
	...
	bool FInfo;
	void __fastcall SetDescription(const System::Classes::TStrings* Value);
	void __fastcall SetPicture(const Vcl::Graphics::TPicture* Value);
...
private:
	...
	void __fastcall SetScriptText(const System::Classes::TStrings* Value);
...
extern PACKAGE System::Uitypes::TColor clTransparent;
...
extern PACKAGE System::Syncobjs::TCriticalSection* frxCS;
extern PACKAGE Frxvariables::TfrxVariables* frxGlobalVariables;
#define FR_VERSION L"4.12"
static const System::Int8 BND_COUNT = System::Int8(0x12);
extern PACKAGE System::StaticArray<TfrxComponentClass, 18> frxBands;
extern PACKAGE Vcl::Forms::TForm* __fastcall frxParentForm(void);
extern PACKAGE TfrxDataSet* __fastcall frxFindDataSet(TfrxDataSet* DataSet, const System::UnicodeString Name, System::Classes::TComponent* Owner);
extern PACKAGE void __fastcall frxGetDataSetList(System::Classes::TStrings* List);
