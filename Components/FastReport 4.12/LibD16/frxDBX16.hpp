...
// (DO NOT EDIT: machine generated header) 'frxDBX16.pas' rev: 23.00 (Win32)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXDBX16)
using namespace Frxdbx16;
#endif
#pragma pack(pop)
#pragma option pop
