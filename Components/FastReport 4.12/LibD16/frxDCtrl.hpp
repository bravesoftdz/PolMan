...
// (DO NOT EDIT: machine generated header) 'frxDCtrl.pas' rev: 23.00 (Win32)
...
private:
	...
	void __fastcall SetLines(const System::Classes::TStrings* Value);
	Vcl::Stdctrls::TScrollStyle __fastcall GetScrollStyle(void);
	bool __fastcall GetWordWrap(void);
	void __fastcall SetScrollStyle(const Vcl::Stdctrls::TScrollStyle Value);
	void __fastcall SetWordWrap(const bool Value);
...
__published:
	...
	__property MaxLength;
	__property ReadOnly = {default=0};
	__property Vcl::Stdctrls::TScrollStyle ScrollBars = {read=GetScrollStyle, write=SetScrollStyle, default=0};
	__property TabStop = {default=1};
...
private:
	...
	void __fastcall SetItems(const System::Classes::TStrings* Value);
