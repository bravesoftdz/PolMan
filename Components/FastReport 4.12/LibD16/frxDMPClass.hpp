...
// (DO NOT EDIT: machine generated header) 'frxDMPClass.pas' rev: 23.00 (Win32)
...
enum TfrxDMPFontStyle : unsigned char { fsxBold, fsxItalic, fsxUnderline, fsxSuperScript, fsxSubScript, fsxCondensed, fsxWide, fsx12cpi, fsx15cpi };
#pragma option pop
