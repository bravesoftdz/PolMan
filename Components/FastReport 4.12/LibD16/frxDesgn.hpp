...
// (DO NOT EDIT: machine generated header) 'frxDesgn.pas' rev: 23.00 (Win32)
...
enum TfrxDesignerUnits : unsigned char { duCM, duInches, duPixels, duChars };
#pragma option pop
...
#pragma option push -b-
enum TfrxDesignerRestriction : unsigned char { drDontInsertObject, drDontDeletePage, drDontCreatePage, drDontChangePageOptions, drDontCreateReport, drDontLoadReport, drDontSaveReport, drDontPreviewReport, drDontEditVariables, drDontChangeReportOptions, drDontEditReportData, drDontShowRecentFiles, drDontEditReportScript, drDontEditInternalDatasets };
#pragma option pop
...
private:
	...
	void __fastcall SetDefaultFont(const Vcl::Graphics::TFont* Value);
...
__published:
	...
	Vcl::Comctrls::TToolButton* SepTB1;
	...
	Vcl::Comctrls::TToolButton* VariablesB;
