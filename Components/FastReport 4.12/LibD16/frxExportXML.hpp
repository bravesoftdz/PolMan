...
// (DO NOT EDIT: machine generated header) 'frxExportXML.pas' rev: 23.00 (Win32)
...
enum TfrxSplitToSheet : unsigned char { ssNotSplit, ssRPages, ssPrintOnPrev, ssRowsCount };
#pragma option pop
