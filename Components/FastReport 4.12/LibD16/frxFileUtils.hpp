...
// (DO NOT EDIT: machine generated header) 'frxFileUtils.pas' rev: 23.00 (Win32)
...
extern PACKAGE int __fastcall StreamSearch(System::Classes::TStream* Strm, const int StartPos, const System::AnsiString Value);
extern PACKAGE System::UnicodeString __fastcall BrowseDialog(const System::UnicodeString Path, const System::UnicodeString Title = System::UnicodeString());
