...
// (DO NOT EDIT: machine generated header) 'frxGradient.pas' rev: 23.00 (Win32)
...
enum TfrxGradientStyle : unsigned char { gsHorizontal, gsVertical, gsElliptic, gsRectangle, gsVertCenter, gsHorizCenter };
#pragma option pop
