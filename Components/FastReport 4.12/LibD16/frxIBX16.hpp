...
// (DO NOT EDIT: machine generated header) 'frxIBX16.pas' rev: 23.00 (Win32)
...
#if !defined(DELPHIHEADER_NO_IMPLICIT_NAMESPACE_USE) && !defined(NO_USING_NAMESPACE_FRXIBX16)
using namespace Frxibx16;
#endif
#pragma pack(pop)
#pragma option pop
