...
// (DO NOT EDIT: machine generated header) 'frxNetUtils.pas' rev: 23.00 (Win32)
...
extern PACKAGE System::UnicodeString __fastcall UpdateCookies(const System::UnicodeString Header, const System::UnicodeString Cookies);
