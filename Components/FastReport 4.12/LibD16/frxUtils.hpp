...
// (DO NOT EDIT: machine generated header) 'frxUtils.pas' rev: 23.00 (Win32)
...
//-- var, const, procedure ---------------------------------------------------
extern PACKAGE unsigned __fastcall frxStreamCRC32(System::Classes::TStream* Stream);
extern PACKAGE System::Classes::TComponent* __fastcall frxFindComponent(System::Classes::TComponent* Owner, const System::UnicodeString Name);
extern PACKAGE void __fastcall frxGetComponents(System::Classes::TComponent* Owner, System::TClass ClassRef, System::Classes::TStrings* List, System::Classes::TComponent* Skip);
extern PACKAGE System::UnicodeString __fastcall frxGetFullName(System::Classes::TComponent* Owner, System::Classes::TComponent* c);
extern PACKAGE void __fastcall frxSetCommaText(const System::UnicodeString Text, System::Classes::TStrings* sl, System::WideChar Comma = (System::WideChar)(0x3b));
extern PACKAGE System::UnicodeString __fastcall frxRemoveQuotes(const System::UnicodeString s);
extern PACKAGE System::UnicodeString __fastcall frxStreamToString(System::Classes::TStream* Stream);
extern PACKAGE void __fastcall frxStringToStream(const System::UnicodeString s, System::Classes::TStream* Stream);
...
extern PACKAGE void __fastcall frxAssignImages(Vcl::Graphics::TBitmap* Bitmap, int dx, int dy, Vcl::Controls::TImageList* ImgList1, Vcl::Controls::TImageList* ImgList2 = (Vcl::Controls::TImageList*)(0x0));
extern PACKAGE void __fastcall frxDrawTransparent(Vcl::Graphics::TCanvas* Canvas, int x, int y, Vcl::Graphics::TBitmap* bmp);
extern PACKAGE void __fastcall frxDrawGraphic(Vcl::Graphics::TCanvas* Canvas, const System::Types::TRect &DestRect, Vcl::Graphics::TGraphic* aGraph, bool IsPrinting, bool Smooth, bool Transparent, System::Uitypes::TColor TransparentColor);
extern PACKAGE void __fastcall frxParsePageNumbers(const System::UnicodeString PageNumbers, System::Classes::TStrings* List, int Total);
extern PACKAGE System::UnicodeString __fastcall HTMLRGBColor(System::Uitypes::TColor Color);
extern PACKAGE void __fastcall frxWriteCollection(System::Classes::TCollection* Collection, System::Classes::TWriter* Writer, Frxclass::TfrxComponent* Owner);
extern PACKAGE void __fastcall frxReadCollection(System::Classes::TCollection* Collection, System::Classes::TReader* Reader, Frxclass::TfrxComponent* Owner);
