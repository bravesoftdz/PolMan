...
// (DO NOT EDIT: machine generated header) 'fs_synmemo.pas' rev: 23.00 (Win32)
...
enum TSyntaxType : unsigned char { stPascal, stCpp, stJs, stVB, stSQL, stText };
#pragma option pop

#pragma option push -b-
enum TCharAttr : unsigned char { caNo, caText, caBlock, caComment, caKeyword, caString };
#pragma option pop
