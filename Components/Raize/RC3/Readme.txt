WELCOME TO RAIZE COMPONENTS VERSION 3.0

CONTENTS
========
  Completing the Raize Components 3.0 Installation
  Uninstalling Raize Components 3.0
  What's New in Raize Components 3.0
...
COMPLETING THE RAIZE COMPONENTS 3.0 INSTALLATION
================================================
  Once the installtion program is complete you may begin using the
  Raize Components in Delphi and C++Builder versions 5 and higher.  Restart
  Delphi or C++Builder and you will see the following pages on the
  component palette:
...
=============================
  ...
  Select the "Raize Components 3.0" package from the Design Packages list 
  ...
  Next, select the "Raize Components 3.0 (Data-Aware)" package from the 
  ...
  "Raize Components 3.0" entry from the list of installed programs, and then
...
==================================
  ...
  directory (e.g. C:\Program Files\Raize\RC3\Help). You can also gain access to
  the help file by selecting Help|Contents from within Delphi or C++Builder and 
  then select the Raize Components 3.0 entry on the contents page.


MINIMUM SYSTEM REQUIREMENTS
===========================
  Raize Components 3.0 requires:
  ...
  At least one of the following compilers:
    ...
    Delphi 7
    C++Builder 5 - Update Pack 1
    C++Builder 6
  
  Hard Disk Space Requirements:  
  
    12 MB + 10 MB for each compiler to be supported
...
===============================
  ...
  These newsgroups are available on the news.raize.com news server.
  
  
  For more information about Raize Components or other Raize Software 
  products, point your web browser to the Raize Software web site at:
...
================================================================================
 ...
 are Copyright © 1995-2003 by Raize Software, Inc.  All rights reserved.
=====================================END========================================
