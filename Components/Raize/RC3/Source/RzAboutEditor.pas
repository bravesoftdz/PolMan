{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Added descriptions for TRzStringGrid, TRzDBGrid, TRzGroupTemplate, TRzGroupController, and
                          TRzFieldStatus.

  3.0    (20 Dec 2002)  * Added new components descriptions.
