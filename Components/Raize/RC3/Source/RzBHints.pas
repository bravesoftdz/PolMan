{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzBalloonHints       Application hints are displayed in a customizable balloon hint window


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0    (20 Dec 2002)  * Removed the BalloonStyle property.
                        * The hint window displayed by the component is much cleaner and is similar to the BalloonHint
                          window implemented in version 5 of the Shell32.dll for Windows.
