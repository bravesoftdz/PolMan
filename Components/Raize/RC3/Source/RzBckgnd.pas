{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzBackground         Graphic control to display gradients, bitmap tiling, and textures.
  TRzSeparator          Graphic control to display a separator - supports gradient fills


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.3  (21 Jan 2003)  * Test FullColorSupport before all calls to PaintGradient in TRzSeparator.

  3.0    (20 Dec 2002)  * Surfaced Anchors and Constraints properties.
