{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Added OnMouseEnter and OnMouseLeave events.
                        * Added Hot property to TRzBmpButton.Bitmaps property. The Hot property is used to specify a
                          bitmap image to be displayed when the mouse is positioned over the button.

  3.0    (20 Dec 2002)  * Fixed problem where clicking on a Down button in a Group and then changing focus caused the
                          button to change to the Up state even though AllowAllUp was False.
                        * Fixed display problems of the focus rectangle.
                        * Added the CaptionDownOffset property, which controls how far down and to the right the caption
      ...
      try
        ...
        case FButtonSize of
          ...
          begin
            ...
            (*
            //!! May want to introduce a Transparent Property to increase performance
