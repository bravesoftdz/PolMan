{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzCheckListTabStopProperty    Displays special dialog to manage tabstops for the TRzCheckList.
  ...
  3.0    (20 Dec 2002)  * Initial release. Created a separate editor (from the TRzTabStopProperty) so that the preview
                          list box can be a TRzCheckList rather than the inherited TRzTabbedListBox.
