{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  3.0.5  (24 Mar 2003)  * The color of flat buttons in TRzDBButtonEdit are now adjusted appropriately when the control
                          is disabled and re-enabled.

  3.0    (20 Dec 2002)  * Fixed display problem when button clicked and focus taken away by an exception.
                        * The OnChange event is no longer fired when the TRzDBButtonEdit control receives the keyboard
                          focus.
