{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzDBLookupDialog     Dialog-based component that allows user to select a record from a dataset


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.9  (22 Sep 2003)  * Replaced TDBGrid in lookup form with TRzDBGrid.

  3.0    (20 Dec 2002)  * Added FramingPreference property.
