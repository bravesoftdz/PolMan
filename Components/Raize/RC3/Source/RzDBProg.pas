{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzDBProgressBar      Data-Aware TRzProgressBar.  Control can be connected to 1) a DataField, 2) a DataField and a
                          BaseValue, or 3) a DataField and a BaseField.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.9  (22 Sep 2003)  * Surface FrameController property introduced in TRzProgressBar.

  3.0    (20 Dec 2002)  * Inherits changes from TRzProgressBar.
