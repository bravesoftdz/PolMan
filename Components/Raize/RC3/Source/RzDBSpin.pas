{=======================================================================================================================
  ...
  3.0.9  (22 Sep 2003)  * Fixed problem in CMFontChanged method where SetEditRect could be called before a window handle
                          has been allocated for the TRzDBSpinEdit.

  3.0.5  (24 Mar 2003)  * The color of flat buttons in TRzDBSpinEdit are now adjusted appropriately when the control
                          is disabled and re-enabled.

  3.0    (20 Dec 2002)  * Inherits changes from TRzSpinEdit.
