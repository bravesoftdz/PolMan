{=======================================================================================================================
  ...
  TRzDBStateStatus      Displays the state of an associated TDataSource component.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * TRzDBStatusPane now descends from the new TRzCustomFieldStatus component.

  3.0    (20 Dec 2002)  * Inherits changes from TRzCustomStatusPane.
