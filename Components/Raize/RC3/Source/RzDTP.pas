{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzDateTimePicker     TDateTimePicker descendant--adds custom framing, Format property, calendar colors, etc.
  ...
  3.0    (20 Dec 2002)  * Deprecated. This component has been replaced by the TRzDateTimeEdit.
