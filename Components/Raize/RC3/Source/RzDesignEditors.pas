{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzComponentEditor               TComponentEditor descendant--implements EditPropertyByName and MenuBitmapResourceName
                                     methods.
  TRzDefaultEditor                 TDefaultEditor descendant--implements EditPropertyByName and MenuBitmapResourceName
                                     methods.

  TRzFrameControllerEditor         Adds context menu to quickly change all connected controls to underline style.
  TRzStatusBarEditor               Adds context menu to quickly add status panes.
  TRzGroupBoxEditor                Adds context menu to TRzGroupBox to quickly change styles
  TRzPageControlEditor             Adds context menu to add new pages, and to cycle through existing pages.
  ...
  TRzFontListEditor                Adds context menu to TRzFontComboBox and TRzFontListBox components.
  ...
  TRzFormEditor                    Adds context menu to TForm components to quickly add RzToolbars, RzStatusBars, etc.
  TRzFrameEditor                   Adds context menu to TFrame components to quickly add RzToolbars, RzStatusBars, etc.
  TRzDateTimeEditEditor            Adds context menu to TRzDateTimeEdit component to switch EditType.
  ...
  TRzVersionInfoStatusEditor       Adds context menu to TRzVersionInfoStatus component.
  ...
  TRzFrameStyleProperty            Displays list of frames styles along with a sample of each style.
  TRzComboBoxTextProperty          Displays list of strings in the Items property.
  TRzActivePageProperty            Provides list of available pages on the current TRzPageControl.
  TRzDateTimeFormatProperty        Provides list of format strings for changing date and time formats.
  TRzClockStatusFormatProperty     Provides list of format strings for changing date and time format in TRzClockStatus.
  TRzDTPFormatProperty             Provides list of format strings for controlling the display of date and time.
  TRzSpinValueProperty             Applies Decimals property to new value assigned to Value property.
  TRzSpinnerGlyphProperty          Prevents the user from editing the old GlyphPlus and GlyphMinus properties since we
                                     can't remove them from the component.
  TRzFileNameProperty              Uses common dialog to select a program or file to launch.
  TRzActionProperty                Displays a list of possible actions (e.g. Open, Explore, Print).
  TRzCustomColorsProperty          Uses a common Color dialog to specify new custom colors.

  TRzAlignProperty
  TRzBooleanProperty

  TRzPaletteSep                    Empty component used for adding a separator to component palette.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.9  (22 Sep 2003)  * Added TRzDateTimeFormatProperty editor which handles displaying date and time format strings
                          in a dropdown list for TRzDateTimeEdit and TRzTimePicker controls.

  3.0.8  (29 Aug 2003)  * Fixed problem where Traditional Style context menu item had no effect on a TRzGlyphStatus.
                        * Fixed problem where TRzFormShape component editor would not update form designer of changes.
                        * Added "Remove Border" item to TRzBorderEditor.
                        * Fixed problem where Show Color Hints and Auto Size menu items for TRzColorPicker did not show
                          correct state.
                        * Added TRzStringGridEditor.
                        * Added "Add a Size Panel" item to TRzFormEditor.
                        * Added TRzFrameEditor, which is similar to the TRzFormEditor in that it provides a quick way
                          to add various controls to the frame.
                        * Added "Add a Group Bar" and "Add a Panel" items to TRzSizePanelEditor.
                        * Fixed problem where TRzPageControl tab sheets (TRzTabSheet) were not selectable when the
                          page control was created on a TFrame.
