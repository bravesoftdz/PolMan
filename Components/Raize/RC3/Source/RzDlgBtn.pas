{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzDialogButtons      Panel component that embeds 3 buttons - OK, Cancel, and Help.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.4  (04 Mar 2003)  * Fixed problem where changing Width* properties did not update display of buttons.

  3.0    (20 Dec 2002)  * Fixed problem where an Action's OnExecute event was not getting fired if the Action was
                          connected to one of the buttons.  The custom click events for each button are still fired.
                          This allows the user to handle the OnClickOK event and set ModalResult to mrNone to prevent
                          the dialog from closing.
                        * When the Align property is anything other than alLeft or alRight, the buttons will be
                          repositioned on the left side of the client area when under a Right-to-Left locale.
