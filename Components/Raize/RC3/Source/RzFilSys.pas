{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzFileListBox        Enhanced TFileListBox--supports custom framing, long file names, shell icons.
  TRzDirectoryTree      Tree view that displays directories and sub-directories.
  TRzDirectoryListBox   Enhanced TDirectoryListBox--supports custom framing, long file names, shell icons.
  TRzDriveComboBox      Enhanced TDriveComboBox--supports custom framing, new glyphs.
  ...
  3.0    (20 Dec 2002)  * Deprecated.  These compoents have been replaced with the new Shell controls: TRzShellTree,
