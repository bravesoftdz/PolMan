{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzFormState          Automatically stores the position, size, and state (maximized or normal) of a form.
  TRzFormShape          Custom image component that removes transparent areas of the image from the form itself.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Fixed problem where form position was not restored correctly when Task Bar was positioned
                          at top of screen.
                        * TRzFormState now verifies that a saved form is restored to a valid monitor.
                        * Added TRzFormState.ValidMonitorAtPoint method in order to support differences between Delphi 5
                          and later versions of Delphi.

  3.0.6  (11 Apr 2003)  * TRzFormState now only stores the Width and Height of a form if the form is resizable.

  3.0.4  (04 Mar 2003)  * Fixed problem with transparency in TRzFormShape when using JPEG and GIF images.
                        * Fixed problem where TRzFormState would prevent app from exiting if associated INI file was
                          read-only or if Registry entry could not be created.

  3.0    (20 Dec 2002)  << TRzFormState >>
                        * Initial release.
