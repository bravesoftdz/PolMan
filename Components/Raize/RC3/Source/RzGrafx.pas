{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  3.0.6  (11 Apr 2003)  * Modified solution introduced in 3.0.5 to prevent repainting by checking that the control
                          is operating at runtime, and not design-time.
                        * Fixed problem where under certain circumstances, cascading access violations could occur
                          within the IDE.  

  3.0.5  (24 Mar 2003)  * Fixed problem where DrawParentImage did not check for Control.Parent being a TCustomFrame.
                          In previous builds, if a control that needed to be transparent was placed on a frame, and then
                          an inline instance of the frame was placed on a panel, which was on a form, the frame would
                          get repeatedly redrawn.

  3.0.4  (04 Mar 2003)  * Fixed problem with FillGradDiag procedure not displaying gdDiagonalDown style correctly.

  3.0.3  (21 Jan 2003)  * Fixed problem with FillGradDiag procedure not filling remaining part of upper triangle.

  3.0    (20 Dec 2002)  * Added FlipBitmap procedure.
