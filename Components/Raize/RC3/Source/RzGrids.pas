{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzStringGrid         Enhanced StringGrid that supports Custom Framing and additional display options for grid cells.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.9  (22 Sep 2003)  * Surfaced OnResize event in TRzStringGrid.

  3.0.8  (29 Aug 2003)  * Initial release.
                        * The TRzStringGrid is a direct descendant of the VCL TStringGrid that supports Custom Framing
