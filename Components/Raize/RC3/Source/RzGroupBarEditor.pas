{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzGroupBarEditor     Allows user to add groups to a TRzGroupBar at design-time.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Fixed problem where group items with a Caption of '-' appeared as a separator line rather than
                          a menu item in the "Edit Item" context menu.

  3.0.6  (11 Apr 2003)  * Fixed problem where adding an item to a group did not call Designer.Modified.
