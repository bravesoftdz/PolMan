{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzImageListEditor    Improved design-time editor for managing images in an ImageList.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.9  (22 Sep 2003)  * Fixed problem where Add/Replace dialog boxes allowed user to select JPG, WMF, and EMF files,
                          which are not valid for the ImageList Editor.
                        * Fixed problem where transparent color of Icons loaded into the editor were not calculated
                          correctly.

  3.0.5  (24 Mar 2003)  * Fixed problem where TransparentColor and FillColor changes made to images were not being
                          stored correctly when applied to the image list.
                        * Fixed problem where Left and Top position of editor was not being restored correctly the
                          next time the dialog box was invoked.
                        * Added missing icon for editor window.

  3.0.3  (21 Jan 2003)  * Fixed problem where reordering images and then deleting an image messed up the list order.
