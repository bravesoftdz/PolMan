{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzLabel              Enhanced label control that supports 3D text styles, angle rotation, fly-by colors, etc.
  TRzURLLabel           TRzLabel descendant that supports linking to a URL.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Fixed problem where changing Color to clWindow would not get streamed correctly.
                        * Added FlatColorAdjustment property.
                        * Added FrameController property.
                        * System cursor (IDC_HAND) is now used in TRzURLLabel instead of the custom hand cursor when
                          running under Windows 98 or higher.
                        * Added CondenseCaption property to TRzLabel. When set to ccAtEnd, if the Caption does not fit
                          within the control's bounds, the end of the string is replaced with an ellipsis (...). When
                          set to ccWithinPath, if the Caption is condense so that the start and end of the path string
                          is displayed within the bounds of the control.
                        ...
                        * Fixed problem where under certain cases the bounds of a TRzLabel component that had a
                          BorderWidth > 0 would not be adjusted when AutoSize was True.

  3.0.6  (11 Apr 2003)  * Added dt_RtlReading flag to DrawText function calls when UseRightToLeftAlignment = True.

  3.0.3  (21 Jan 2003)  * Fixed problem with AdjustForLayout method where it was offsetting rectangle uncessarily.

  3.0    (20 Dec 2002)  * The FrameSides property has been removed from the TRzLabel component.
