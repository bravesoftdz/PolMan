{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzLauncher           Used to launch another process from within your application.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.5  (24 Mar 2003)  * When WaitUntilFinished is False, Launch method will not return until Running is set to True.
                        * Added new Execute method that starts the specified process without monitoring for termination.

  3.0    (20 Dec 2002)  * Added the Running property.
                        * Event handlers are now generated within the context of the main application thread.
                        * When WaitUntilFinished is True, the new WaitType property controls whether the application
                          completely stops, while waiting for the launched process to finish (wtFullStop), or to
                          continue processing messages while waiting for the launched process to finish
                          (wtProcessMessages).
