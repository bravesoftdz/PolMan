{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzLine               Graphic control that display a single line between opposite corners of the bounding rectangle.
                          Arrows on either end optional.  OnClick event only generated when user clicks on the line,
                          not the bounding rectangle.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.4  (04 Mar 2003)  * Added Align, Anchors, and Constraints properties.
