{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzLookupDialog       When launched, displays a dialog contains an edit field and a list box.  Allows a user to select
                          an item from a list using more space than just a combo box drop-down list.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0    (20 Dec 2002)  * Surfaced CharCase property for the search edit field in the lookup dialog box.  The new
                          FlatColor property can be used to change the color of the line that is drawn for the border.
                        * Add component editor to TRzLookupDialog so that the dialog can be tested at design-time.
