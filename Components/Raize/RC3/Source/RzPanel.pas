{=======================================================================================================================
  ...
  TRzGroupBox           Custom group box component with more display options and functionality.
  TRzSpacer             Separator control designed to be used on a TRzToolbar.
  TRzToolbar            Custom TRzPanel control designed to function as a toolbar.
  TRzStatusBar          Custom TRzPanel control designed to functiona as a status bar.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.9  (22 Sep 2003)  * Surface the OnPaint event and Canvas property in TRzToolbar.
                        * Added FrameController property to TRzGroupBox. This associate FrameController can be used to
                          change the appearance of the group box when the GroupStyle property is set to gsCustom.

  3.0.8  (29 Aug 2003)  * Surfaced the OnPaint event in TRzGroupBox. This is useful when GroupStyle is set to gsCustom.
  ...
  3.0.6  (11 Apr 2003)  * Changing TRzGroupBox.GroupStyle to gsTopLine or gsCustom causes ThemeAware to be changed to
                          False.

  3.0.5  (24 Mar 2003)  * Fixed problem where background of TRzGroupBox was not getting drawn when using XP Themes.

  3.0.4  (04 Mar 2003)  * Modified alignment code of TRzStatusBar so that panes appear positioned more appropriately
                          when running under Windows XP.
                        * Added ShowTextOptions parameter to TRzToolbar.Customize method.

  3.0    (20 Dec 2002)  << TRzCustomPanel and TRzPanel >>
                        * All panel controls now keep track of Enabled/Disabled children and then restore these values
                          when the panel is re-enabled.
                        * Added FlatColorAdjustment property.
                        * The TRzPanel now supports displaying a grid on its canvas. The ShowGrid, GridStyle, GridXSize,
                          GridYSize, and GridColor properties control how the grid is displayed.
                        * The custom docking manager has been updated to show focus changes.
                        * The FrameSides property has been removed from the TRzCustomPanel component.

                        << TRzGroupBox >>
                        * Added the gsFlat GroupStyle for all Raize group boxes.
                        * When BorderWidth is larger than the height of the Caption, then the client area of the group
                          box is no longer adjusted by the height of the caption.
                        * Added XP visual styles support.

                        << TRzToolbar >>
                        * The TRzToolbar has received a number of enhancements including support for an ImageList,
                          runtime customizations, etc.
                        * Added XP visual styles support.

                        << TRzStatusBar >>
                        * Updated display of size grip to match Windows XP style.  The size grip now automatically
                          detects the state of the parent form to determine if the size grip is valid.  For example, the
                          size grip is not valid for a form with a BorderStyle of bsDialog.  The size grip is also not
                          valid for a maximized form.
