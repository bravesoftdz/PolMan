{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzProgressBar        Custom graphic control used to display progress information (percentage)


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.9  (22 Sep 2003)  * Added FrameController property, which can be used to control the frame that appears around
                          the progress bar.

  3.0.8  (29 Aug 2003)  * Fixed problem where fsFlatBold borders were not drawn with FlatColor value.
  ...
  3.0.6  (11 Apr 2003)  * Fixed painting problem of rounded corners of progress bar when used as a status pane.

  3.0    (20 Dec 2002)  * Added FlatColor and FlatColorAdjustment property.
