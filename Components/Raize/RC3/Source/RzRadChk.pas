{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzRadioButton        Custom radio button control--supports multi-line captions, 3D text styles, custom glyphs
  TRzCheckBox           Custom check box control--supports multi-line captions, 3D text styles, custom glyphs


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.4  (04 Mar 2003)  * Fixed display problems when running under Right-To-Left locales.
                        * Fixed display problems when running under 256 and 16-bit color depths.
                        * Fixed problem of disappearing check marks and radio button circles when Highlight color is
                          clTeal as is used in the Dessert color scheme.

  3.0.3  (21 Jan 2003)  * Added GetHotTrackRect override.

  3.0    (20 Dec 2002)  * Added HotTrack property.
