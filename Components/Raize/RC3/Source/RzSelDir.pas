{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzSelDirDialog       Dialog-based component to allow user to select a directory.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0    (20 Dec 2002)  * Deprecated.  This control has been replaced by the new Shell Dialog base controls.
                        * Fixed problem where setting Directory property and setting FrameVisible to True would cause an
                          access violation when the dialog was displayed.
