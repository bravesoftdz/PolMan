{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzSelectImageEditor                Provides a quick way of selecting glyphs for TRzToolarButton and TRzToolButton
                                        components.
  TRzToolButtonEditor                 Adds a context menu to quickly change several properties of a TRzToolButton.
  TRzBitBtnEditor                     Adds a context menu to quickly change several properties of a TRzMenuButton.
  TRzMenuButtonEditor                 Adds a context menu to quickly change several properties of a TRzMenuButton.

  TRzCustomImageIndexProperty         Displays image index values (and each image) associated with an ImageList.
  TRzToolButtonImageIndexProperty     Property editor for TRzToolButton.ImageIndex property
  TRzTabSheetImageIndexProperty       Property editor for TRzTabSheet.ImageIndex property
  TRzGroupCaptionImageIndexProperty   Property editor for TRzGroup.CaptionImageIndex property
  TRzGroupItemImageIndexProperty      Property editor for TRzGroupItem.ImageIndex property
  TRzGroupTemplateCaptionImageIndexProperty   Property editor for TRzGroupTemplate.CaptionImageIndex property
  TRzGroupTemplateItemImageIndexProperty      Property editor for TRzGroupTemplateItem.ImageIndex property
  TRzAnimatorImageIndexProperty       Property editor for TRzAnimator.ImageIndex property
  TRzTrayIconIndexProperty            Property editor for TRzTrayIcon.IconIndex property

  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Reconnected Edit Hint and Delete popup menu items in the Custom images group box.
