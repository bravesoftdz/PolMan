{=======================================================================================================================
  ...
  1.6a   (11 Jan 2002)  * Removed dependency on OLE2 unit.
                        * Renamed all symbols for C++Builder.
                        * Interfaces are suffixed with _NRC standing for "No Reference Counting".
                        * Trimmed unused declarations.

  1.6    (02 Jul 2001)  * Delphi 6 support.
  1.5c   (30 Mar 2001)  * No changes.
  1.5b   (12 Dec 2000)  * Fixed another C++Builder header problem.
  1.5a   (14 May 2000)  * Fixed another C++Builder header problem.
  1.5    (03 Mar 2000)  * C++Builder 5 support.
                        * Fixed C++Builder header problems when using WebBrowser and Shell Controls in the same form.

  1.4a   (15 Dec 1999)  * No changes.
  1.4    (14 Sep 1999)  * Some exclusions to prevent namespace conflicts when using C++Builder 4.
  1.3h   (29 Mar 1999)  * No changes.
  1.3g   (01 Dec 1998)  * No changes.
  1.3f   (12 Jul 1998)  * Delphi 4 support.
                        * Fixes for C++Builder 3.

  1.3e   (22 Apr 1998)  * No changes.
  1.3d   (18 Apr 1998)  * No changes.
  1.3c   (16 Mar 1998)  * C++Builder 3 support.
  1.3b   (07 Feb 1998)  * No changes.
  1.3a   (07 Jan 1998)  * Changed SHGetDataFromIDList to dynamic link.
  1.3    (28 Nov 1997)  * No changes.
  1.2b   (12 Oct 1997)  * Fixed declaration of IContextMenu2.
  1.2a   (05 Oct 1997)  * No changes.
  1.2    (06 Sep 1997)  * Removed package warnings.
  1.1a   (06 Jul 1997)  * Added support for C++ Builder.
  1.1    (26 Jun 1997)  * No changes.
  1.0c   (31 May 1997)  * No significant changes.
  1.0b   (17 May 1997)  * Delphi 3 support.
  1.0a   (01 May 1997)  * No significant changes.
