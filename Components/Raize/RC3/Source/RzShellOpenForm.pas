{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Fixed problem where ShellList would not be initialized correctly if user specified a Filter
                          and FilterIndex value for the TRzOpenDialog or TRzSaveDialog.
                        * Replaced call to Application.HelpContext with a call to Application.HelpCommand to work-
                          around the problem of HelpContext not generating a wm_Help message.
  ...
  1.5a   (14 May 2000)  * Changed behaviour of DefaultExt and the selected file type to match the Borland
                          controls. If the entered file has an unrecognized extension, and an extension is
                          selected in the file type combobox then that extension is used in preference to
                          the DefaultExt property. This is how the Borland TSaveDialog behaves.
  1.5    ( 3 Mar 2000)  * Added C++Builder 5 support.
  1.4a   (15 Dec 1999)  * No changes.
  1.4    (14 Sep 1999)  * Changed behaviour of Executing property. It is now True during the OnFormShow event.
                        * Fixed handling of DefaultExt property in the case where the user enters an extension
                          that matches DefaultExt, but that extension is not registered. It would add the
                          extension again, now it doesn't.
                        * Fixed occasional visual glitch with size-grip control.
  1.3h   (29 Mar 1999)  * Added Show Desktop button. Note that the hint for this button is not translated.
                        * Added size-grip to bottom right corner of form.
                        * Fixed setting of current directory, now sets the current directory on form exit to
                          the Folder property of the TPTShellList control.
                        * Changed behaviour when multiple items are selected. Before 1.3h, all the selected
                          files needed to exist (ptofFileMustExist option was forced on). This is no longer the case.
  1.3g   ( 1 Dec 1998)  * Fixed DefaultExt property, now works again.
  1.3f   (12 Jul 1998)  * Fixed problem with OnAddListItem event not firing.
                        * Changed various things to support Delphi 4.
  1.3e   (22 Apr 1998)  * No changes.
  1.3d   (18 Apr 1998)  * Added public Form property, giving access to the form object from component events.
  ...
  1.3c   (16 Mar 1998)  * Added ptofShowHidden options.
                        * Added virtual Resize method instead of FormResize event handler.
                        * C++Builder 3 support.
  1.3b   ( 7 Feb 1998)  * Added OnHelp event for Delphi 3 only. The OnHelp event is available in Delphi 2 and C++Builder 1
  ...
  1.3a   ( 7 Jan 1998)  * Fixed ptofNoChangeDir. When false, the current directory is now changed.
  1.3    (28 Nov 1997)  * Added internationalisation support.
  1.2b   (12 Oct 1997)  * No changes.
  1.2a   ( 5 Oct 1997)  * No changes.
  1.2    ( 6 Sep 1997)  * Changed FilterIndex from 0 to 1 based to match documentation and TOpenDialog.
  ...
  1.1a   ( 6 Jul 1997)  * Fixed problem when using ptofHideFoldersInListWhenTreeVisible option and creating new folders.
                        * C++ Builder support.
  1.1    (26 Jun 1997)  * Fixed Access Violation caused when using the (useless) HistoryList property.
                        * Added popup menu to shell list.
                        * Added custom draw events for tree and list controls.
  1.0c   (31 May 1997)  * Minor changes to PTShellList1Change method for extra performance.
                        * Added ptofHideFoldersInListWhenTreeVisible option.
  1.0b   (17 May 1997)  * Delphi 3 support.
  1.0a   ( 1 May 1997)  * No changes.
