{=======================================================================================================================
  ...
  Implements low-level utilities useful for dealing with shell interfaces and structures. Also includes utilities
  for creating and resolving shortcuts.
  ...
  1.7a   --TBA--        * Added fnForEditing to TRzFriendlyNameFlags.
  1.7    (12 Sep 2002)  * Added ShellCSIDLEqualsIdList.

  1.6b   ( 7 Mar 2002)  * Added TRzModuleVersion.asInt64.
                        * Changed ResolveShortcut to disable error message display for shortcut types that don't correctly
                          respond to the SLR_NO_UI flag.

  1.6a   (11 Jan 2002)  * Added new values to TCSIDL enumeration.
                        * Added ShellGetFriendlyNameForLastIdListElement.

  1.6    ( 2 Jul 2001)  * Added ShellGetSpecialFolderIconIndex.
  1.5c   (30 Mar 2001)  * Fixed a memory leak in ShellFindCSIDLFromIdList.
  ...
  1.5b   (12 Dec 2000)  * The hidden DeviceChangeHandler window now calls DefWndProc.
  1.5a   (14 May 2000)  * No changes.
  1.5    ( 3 Mar 2000)  * C++Builder 5 release.
                        * Added 'noUi' option to TLinkData record.
                        * Fixed WM_QUERYENDSESSION handling in hidden window used by DeviceChangeHandler.

  1.4a   (15 Dec 1999)  * Added FlushDriveInfoCache, LockFlushDriveInfoCache, and UnlockFlushDriveInfoCache to work around
                          the Windows bug where drive information is cached too vigorously.
                        * Added TRzDeviceChangeHandler class to manage broadcasting of WM_DEVICECHANGE messages to
                          components that wouldn't normally receive the message, but want it (like TRzShellTree and
                          TRzShellList).

  1.4    (14 Sep 1999)  * Added ShellFindCSIDLFromIdList.
  1.3h   (29 Mar 1999)  * Changed handling of cached IMalloc ptr g_IShm during some shutdown situations on NT4.
                        * Fixed problem with EnsureTrailingCharDB function. It didn't actually work for double-byte
                          character sets.

  1.3g   ( 1 Dec 1998)  * Added ShellIMalloc.
  1.3f   (12 Jul 1998)  * Delphi 4 release, no changes.
  1.3e   (22 Apr 1998)  * Added TRzPidlList object.
  1.3d   (18 Apr 1998)  * No changes.
  1.3c   (16 Mar 1998)  * C++Builder 3 support.
  1.3b   ( 7 Feb 1998)  * Added GetModuleVersion function and TRzModuleVersion type.
                        * Added constants, types and variable COMCTL32_VER for determining the version of comctl32.dll
                          at run-time.
                        * Changed ShellGetSystemImageList to support shell link and network share overlay fix on
                          WinNT/IE4.

  1.3a   ( 7 Jan 1998)  * Added ShellGetIconIndexFromExt.
                        * Added ShellGetIconIndexFromPath.

  1.3    (28 Nov 1997)  * No changes.
  1.2b   (12 Oct 1997)  * No changes.
  1.2a   ( 5 Oct 1997)  * No changes.
  1.2    ( 6 Sep 1997)  * Added RzClsidFromFileType.
                        * ShellMemAlloc, ShellMemRealloc and ShellMemFree now used a cached IMalloc interface.
                        * ShellGetIconIndex method added.

  1.1a   ( 6 Jul 1997)  * Removed HWND params for C++Builder support.
  1.1    (26 Jun 1997)  * Fixed CompareAbsIdLists when Desktop folder used as either or both parameters.
  1.0c   (31 May 1997)  * No significant changes.
  1.0b   (17 May 1997)  * Delphi 3 support. Adjusted StrretFree to prevent exceptions under WinNT.
  1.0a   ( 1 May 1997)  * Added IsWinNT, IsWin95, HasWin95Shell functions.
