{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzSendMessage        Non-visual component that wraps functionality of Simple Messaging API (MAPI) allowing a user
                        to send email messages using a MAPI compliant mail service.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Modified the Send method so that directory that is current before the call to Send is restored
                          at the end of the Send method.

  3.0    (20 Dec 2002)  * Attachments are no longer allocated a space in the message text for positioning.
