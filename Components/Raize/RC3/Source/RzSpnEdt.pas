{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzRapidFireButton    TSpeedButton descendant that generates OnClick events as button is held down.
  TRzSpinButtons        Compound component with two TRzRapidFireButtons--Up/Down or Left/Right.
  TRzSpinEdit           Enhanced TRzEdit that embeds a TRzSpinButtons component. Used for cycling through numeric
                          values (Integer and Floating-point).
  TRzSpinner            Alternate control for cycling through integer values.  Buttons are on left and right sides of
                          display area.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.9  (22 Sep 2003)  * Fixed problem in CMFontChanged method where SetEditRect could be called before a window handle
                          has been allocated for the TRzSpinEdit.

  3.0.8  (29 Aug 2003)  * System cursor (IDC_HAND) is now used in TRzSpinner instead of the custom hand cursor when
                          running under Windows 98 or higher.

  3.0.5  (24 Mar 2003)  * The color of flat buttons in TRzSpinEdit are now adjusted appropriately when the control
  ...
  3.0    (20 Dec 2002)  << TRzSpinEdit >>
                        * Fixed display problem when button clicked and focus taken away by an exception.
                        * Fixed problem where changing the font color in the OnExit and OnEnter events caused the text to
                          disappear.
                        * The OnChange event is no longer fired when the TRzDBSpinEdit control receives the keyboard
                          focus.
                        * The Buttons are now placed on the left side of the control for Right-To-Left locales.
                        * Fixed problem where disabling the control did not cause the buttons to appear disabled.

                        << TRzRapidFireButton >>
                        * Added ScrollStyle property, which allows the user to easily set the glyph of the button to a
                          scroll arrow.
                        ...
                        * Fixed display problem when button clicked and focus taken away by an exception.
                        ...
                        << TRzSpinner >>
                        * Redesigned TRzSpinner to remove embedded controls. Also can use an image for button images.
                        * Fixed display problem when button clicked and focus taken away by an exception.
