{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzStringListProperty   This unit file contains a replacement string list property editor and its associated dialog
                          box.  After installing this unit into the Delphi IDE, this editor will be used to edit all
