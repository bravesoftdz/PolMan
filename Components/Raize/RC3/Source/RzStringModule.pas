{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzStringModuleCreator  This unit implements the TRzStringModuleCreator and the TRzOTAFile classes. These classes
                          are used in the Raize String List editor to implement the Code Editor button in Delphi 5
                          and higher.
