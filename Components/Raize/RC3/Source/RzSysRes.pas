{=======================================================================================================================
  ...
  This is an interface unit to the RSRC32.DLL which provides a thunking layer to the Free System Resource values under
  Win32, specifically Win95 and Win98. Note that this unit is only valid under Win32 and that the RSRC32.DLL is
  not available on WinNT systems.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0    (20 Dec 2002)  * No changes.
