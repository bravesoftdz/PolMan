{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzTabStopProperty      Displays special dialog to manage tabstops for the TRzTabbedListBox.
  TRzTabbedListBoxEditor  Adds context menu to edit the tab stops, add items, and set the Align property.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Added TabStopsMode options to Tab Stop dialog box.
                        * Added "Manual Tab Stops" and "Automatic Tab Stops" items to context menu for TRzTabbedListBox.
                        * Added "Show Groups" item to context menu for TRzTabbedListBox.

  3.0    (20 Dec 2002)  * Updated form to use custom framing editing controls and HotTrack style buttons, radio buttons,
                          and check boxes.
