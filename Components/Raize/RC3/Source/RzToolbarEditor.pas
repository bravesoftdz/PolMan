{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  3.0    (20 Dec 2002)  * Rearranged and incorporated brand new 256 color images for glyphs.
                        * Redesigned the Custom Image area to mimic the stock image area.
                        * Added the Images list, which displays all images currently in the associated ImageList.
                        * The editor now supports specifying a suffix to be used when creating the name for a newly
                          created button.
