{=======================================================================================================================
  ...
  This form is used to specify a prefix or suffix to be used when naming new TRzToolButton and TRzSpacer components.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0    (20 Dec 2002)  * Added support for specifying a suffix as well as a prefix.
