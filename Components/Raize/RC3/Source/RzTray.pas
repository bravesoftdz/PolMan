{=======================================================================================================================
  ...
  ----------------------------------------------------------------------------------------------------------------------
  TRzTrayIcon           Nonvisual component that allows application to have an icon in the system tray.


  Modification History
  ----------------------------------------------------------------------------------------------------------------------
  3.0.8  (29 Aug 2003)  * Fixed problem where setting Enabled to True, when the control was already Enabled caused an
                          exception.
                        * Animation of icons now only occurs at runtime.
                        * Fixed problem where application would hang if RestoreOn was set to ticLeftClick and the icon
                          was left-clicked while a popup menu was currently being displayed.  

  3.0    (20 Dec 2002)  * Fixed problem where setting Enabled to False still resulted in the tray icon data structure
                          to be created when the component was created, and then turned off during loading.  Now, the
                          tray icon data structure is not created until the first time the Enabled property is set
                          to True.
                        * Added the HideOnMinimize option that controls whether the button in the Task Bar remains visible
                          when the main form is minimized.
                        * If Windows Explorer is restarted, enabled TRzTrayIcon tray icons will be recreated.
                        * Added new methods ShowBalloonHint and HideBalloonHint, which allows a user to display the
                          BalloonHints that are available with version 5 or higher of the Shell32.dll.  The TRzTrayIcon
                          also adds the following events:  OnBalloonHintHide, OnBalloonHintClosed, and
                          OnBalloonHintClicked;
